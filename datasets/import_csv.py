...
while True:
    ...
    while True:
        ...
        if table in create_table_sql:
            break
        else:
            print(f"ERROR: Invalid table name. Valid options: {', '.join(create_table_sql.keys())}")
    ...
    while True:
        ...
        if not os.path.isfile(path):
            ...
            print("Please select another CSV file.")
            continue
    ...
    # ============================================
    again = input(
        "\nDo you want to import another CSV? (Y/N): "
    ).strip().lower()
